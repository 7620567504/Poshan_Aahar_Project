...
<html>
	...
	<body>
		...
		//int id= User.getIntSchoolId();
		int id = User.getSchoolId();
		PreparedStatement stmt=con.prepareStatement("update screq set approve=? where ScId=?");
		stmt.setString(1,"done");
		stmt.setInt(2,id);
		
		int i= stmt.executeUpdate();
	PreparedStatement st=con.prepareStatement("select sId from sup ");
